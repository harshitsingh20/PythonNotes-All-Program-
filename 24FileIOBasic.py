...
"""
#How to open different files in this one .txt

#Basic Syntax to read the file is

open("26harshit.txt") #But This is not showing the output

# So we have to make a file pointer

v= open("26harshit.txt","rb") #r:- It means read. rb:- read in birnary form . rt:- text mode
content=v.read(7)        #Read Function     we write 5 so its gives only 5 values
print(content)
v.close()       #Close Function
